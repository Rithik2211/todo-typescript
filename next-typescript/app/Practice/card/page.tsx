  ...
  return (
    <div className='h-screen w-full flex justify-center items-center p-6'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-10 grid-rows-8 h-full w-full gap-4'>
          <div className='col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-4 xl:col-span-6 row-span-2 sm:row-span-2 md:row-span-2 lg:row-span-6 xl:row-span-6 bg-indigo-400 rounded-3xl flex justify-center items-center'>Feature</div>
